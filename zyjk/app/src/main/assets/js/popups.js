...
function jqalert(param) {
    ...
    if (prompt){
        ...
        //htm += '<input type="text" class="prompt-text">';
        htm += '<select  class="prompt-text" size="5" width="100%"><option>11</option><option>22</option><option>11</option><option>22</option><option>11</option><option>22</option></select>';
        htm +='</div></div>';
    }else {
